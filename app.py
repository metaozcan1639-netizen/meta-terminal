...
async def analyze_symbol(exchange, symbol):
    try:
        ...
        if len(system_state["radar_symbols"]) > 100:  # Tarama tablosu genişletildi
        ...
        if trend_bull:
            ...
            radar_item["trend"] = "YATAY"
            radar_item["score"] = score
            return None # Radarda 0 puanla kalır ama işleme girmez

        radar_item["trend"] = direction
        ...
        if is_pullback:
            ...
            radar_item["score"] = score
            return None # Radarda 35 puanla kalır ama işleme girmez
        ...
        # --- YENİ EKLENEN: İŞLEM DURDURULDUYSA VEYA ZARAR KESİLDİYSE ÇIK ---
        ...
        if direction == "LONG":
            ...
            # İğne ucunun tam 0.5 * ATR altına güvenli hedef konur
            ...
            # EĞER R:R KURTARMIYORSA ZORLA YUKARI TAŞIMA, İŞLEMİ REDDET!
            ...
            # İğne ucunun tam 0.5 * ATR üstüne güvenli hedef konur
            ...
            # EĞER R:R KURTARMIYORSA ZORLA AŞAĞI TAŞIMA, İŞLEMİ REDDET!
...
async def market_scanner_loop():
    ...
    add_log("Quant Motoru: Katı R:R Doğrulaması ve Likidite Önü Çıkış Devrede...")
            ...
            for pos in list(system_state["active_positions"]):
                try:
                    ...
                    if (direction == "LONG" and curr_price <= pos['sl']) or (direction == "SHORT" and curr_price >= pos['sl']):
                        ...
                        # TEK TEPE VARSA %100 KAPAT (DİNAMİK BİRLEŞTİRME)

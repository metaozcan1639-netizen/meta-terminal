...
async def analyze_symbol(exchange, symbol):
    try:
        ...
        # Binance Kaldıraç Koruma Kalkanı (exchangeInfo)
        ...
        <script>
            ...
            function recalculateAdvancedStats() {
                try {
                    ...
                    let symbolGrossProfit = {}, symbolGrossLoss = {}, symbolTradeCount = {};
                    let pnlSeries = [], currentWinStreak = 0, maxWinStreak = 0, currentLossStreak = 0, maxLossStreak = 0;
